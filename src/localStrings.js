...
let localStrings = new LocalizedStrings({
    fr: {
        ...
        warningMessage: {
            ...
            minimalPriceForDeliveryNoReached: "La livraison n'est disponible que pour un montant minimum de {0} {1}",
    ...
    en: {
        ...
        "warningMessage": {
            ...
            "minimalPriceForDeliveryNoReached": "Delivery is only available for a minimum amount of {0} {1}",
